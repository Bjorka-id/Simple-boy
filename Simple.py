...
author = 'Bjorka-id'
git_hub = 'github.com/Bjorka-id'
faceb0ok = 'Wibu Nolep Wibu Nolep'
...
█ ▲▲▲▲▲ -_-- -╚═╩═╝╚═╝╚═╝╚═╝╚═╝╚╩═╩╝╚═╝
█████████      «°°°°°°°°°°✧°°°°°°°°°°»
 ██ ██.{m} ☯︎ {k} ☯︎ {h} ☯︎ {sir} Recode : Bjorka-id{x}{m} ☯︎ {k} ☯︎ {h} ☯︎ {x}
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
{k}[•]PREMIUM
[•]https://github.com/Bjorka-id
[•]ANONYMOUS✓""")
...
###---[ CLEAR LAYAR ]---###
def clear_layar():
	try:os.system("xdg-open https://wa.me/6289604289872?text=assalamualaikum,+bang+gw+izin+make+scriptnya")
	except:pass
